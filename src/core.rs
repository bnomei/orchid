...
pub(crate) enum ErrorCode {
    ...
    CompletionIntentConflict,
    CompletionIntentMissing,
    CorruptLeaseFile,
    HumanCheckpoint,
    InactiveSpec,
    InvalidDuration,
    ...
    InvalidReportKind,
    InvalidReportStatus,
    InvalidValidatorVerdict,
    ValidatorStatusMismatch,
    InvalidScope,
...
impl ErrorCode {
    pub(crate) fn as_str(self) -> &'static str {
        match self {
            ...
            ErrorCode::CompletionIntentConflict => "completion_intent_conflict",
            ErrorCode::CompletionIntentMissing => "completion_intent_missing",
            ...
            ErrorCode::LeaseOwnerRequired => "lease_owner_required",
            ErrorCode::ReportLeaseMismatch => "report_lease_mismatch",
            ErrorCode::ReportDraft => "report_draft",
            ErrorCode::ReportContextMismatch => "report_context_mismatch",
            ErrorCode::ReportLeaseInstanceMismatch => "report_lease_instance_mismatch",
            ...
            ErrorCode::NoOpenSpec => "no_open_spec",
            ErrorCode::InvalidReportKind => "invalid_report_kind",
            ErrorCode::InvalidReportStatus => "invalid_report_status",
            ErrorCode::InvalidValidatorVerdict => "invalid_validator_verdict",
            ErrorCode::ValidatorStatusMismatch => "validator_status_mismatch",
